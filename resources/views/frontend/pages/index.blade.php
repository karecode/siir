                ...
                <div id="rev_slider_34_1" class="rev_slider fullwidthabanner" style="display:none;"
                    ...
                    <ul>    <!-- SLIDE  -->
                        <li data-index="rs-129" data-transition="parallaxvertical" data-slotamount="default"
                            ...
                            data-thumb="/images/bg-1.jpg" data-rotate="0" data-fstransition="fade"
                            data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"
                            data-title="A STUDY ON HAPPINESS"
                            data-description="Science says that Women are generally happier">
                            <!-- MAIN IMAGE -->
                            <img src="/images/bg-1.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                            ...
                            <div class="tp-caption Newspaper-Title   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">Science
                                says that Women are generally happier
                            </div>
                        ...
                        <li data-index="rs-130" data-transition="parallaxvertical" data-slotamount="default"
                            data-easein="default" data-easeout="default" data-masterspeed="default"
                            data-thumb="/images/bg-3.jpg" data-rotate="0" data-saveperformance="off"
                            data-title="THE REAL DEAL" data-description="Every right implies a responsibility.">
                            <!-- MAIN IMAGE -->
                            <img src="/images/bg-3.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                                 data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            ...
                            <div class="tp-caption Newspaper-Title   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">Every
                        ...
                        <li data-index="rs-131" data-transition="parallaxvertical" data-slotamount="default"
                            data-easein="default" data-easeout="default" data-masterspeed="default"
                            data-thumb="/images/bg-4.jpg" data-rotate="0" data-saveperformance="off"
                            data-title="NATURAL BEAUTY"
                            data-description="There was never a night or a problem that could defeat sunrise or hope.">
                            <!-- MAIN IMAGE -->
                            <img src="/images/bg-4.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                                 data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            ...
                            <div class="tp-caption Newspaper-Title   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">There was
                        ...
                        <li data-index="rs-132" data-transition="parallaxvertical" data-slotamount="default"
                            data-easein="default" data-easeout="default" data-masterspeed="default"
                            data-thumb="/images/bg-2.jpg" data-rotate="0" data-saveperformance="off"
                            data-title="WORDS OF WISDOM"
                            data-description="Walking with a friend in the dark is better than alone in the light.">
                            <!-- MAIN IMAGE -->
                            <img src="/images/bg-2.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                                 data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            ...
                            <div class="tp-caption Newspaper-Title   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">Walking
                                with a friend in the dark is better than alone in the light.
                            </div>
            ...
            <div class="col-md-8">
                <div class="post">
                    ...
                    <div class="post-entry">
                        <p>
                            È universalmente riconosciuto che un lettore che osserva il layout di una pagina viene
                            distratto dal contenuto testuale se questo è leggibile. Lo scopo dell’utilizzo del Lorem
                            Ipsum è che offre una normale distribuzione delle lettere (al contrario di quanto avviene se
                            si utilizzano brevi frasi ripetute, ad esempio “testo qui”), apparendo come un normale
                            blocco di testo leggibile. Molti software di impaginazione e di web design utilizzano Lorem
                            Ipsum come testo modello.
                        </p>
                        <p>
                            Esistono innumerevoli variazioni dei passaggi del Lorem Ipsum, ma la maggior parte hanno
                            subito delle variazioni del tempo, a causa dell’inserimento di passaggi ironici, o di
                            sequenze casuali di caratteri palesemente poco verosimili. Se si decide di utilizzare un
                            passaggio del Lorem Ipsum, è bene essere certi che non contenga nulla di imbarazzante.
                        </p>
                        <br>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="post grid-post">
                            ...
                            <div class="post-entry">
                                <p>
                                    Esistono innumerevoli variazioni dei passaggi del Lorem Ipsum, ma la maggior parte
                                    hanno subito delle variazioni del tempo, a causa dell’inserimento di passaggi
                                    ironici, o di sequenze casuali di caratteri palesemente poco verosimili.
                                </p>
                            </div><!--post entry-->
                ...
                <aside class="sidebar">
                    ...
                    <div class="widget text-center">
                        ...
                        <p>
                            ...
                            v laborum. Aliquip veniam delectus
                        </p>
                        <a href="#">Read More</a>
                    </div><!--widget-->
                    <div class="widget text-center">
                        ...
                        <div class="fb-page" data-href="https://web.facebook.com/rakeshdesigns/"
                             data-small-header="false" data-adapt-container-width="true" data-hide-cover="false"
                             data-show-facepile="true" data-show-posts="false">
                            <div class="fb-xfbml-parse-ignore">
                                <blockquote cite="https://web.facebook.com/rakeshdesigns/"><a
                                            href="https://web.facebook.com/rakeshdesigns/">Design_mylife</a>
                                </blockquote>
                            </div>
                        </div>
                    </div><!--widget-->

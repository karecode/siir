    ...
    <article class="slider-container">
        ...
        <div id="rev_slider_34_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="news-gallery34" style="margin:0px auto;background-color:#ffffff;padding:0px;margin-top:0px;margin-bottom:0px;">
            ...
            <div id="rev_slider_34_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                <ul>	<!-- SLIDE  -->
                    <li data-index="rs-129" data-transition="parallaxvertical" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="/images/bg-1.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="A STUDY ON HAPPINESS" data-description="Science says that Women are generally happier">
                        <!-- MAIN IMAGE -->
                        <img src="/images/bg-1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                    ...
                    <!-- SLIDE  -->
                    <li data-index="rs-130" data-transition="parallaxvertical" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="/images/bg-3.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="THE REAL DEAL" data-description="Every right implies a responsibility.">
                        <!-- MAIN IMAGE -->
                        <img src="/images/bg-3.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                    ...
                    <!-- SLIDE  -->
                    <li data-index="rs-131" data-transition="parallaxvertical" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="/images/bg-4.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="NATURAL BEAUTY" data-description="There was never a night or a problem that could defeat sunrise or hope.">
                        <!-- MAIN IMAGE -->
                        <img src="/images/bg-4.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                    ...
                    <!-- SLIDE  -->
                    <li data-index="rs-132" data-transition="parallaxvertical" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="/images/bg-2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="WORDS OF WISDOM" data-description="Walking with a friend in the dark is better than alone in the light.">
                        <!-- MAIN IMAGE -->
                        <img src="/images/bg-2.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="post">
                <div class="post-header text-center">
                    <span class="tag"><a href="#"><i class="fa fa-tag"></i> Travel</a></span>
                    <h3 class="post-title"><a href="#">Lorem ipsum cogarts elit down</a></h3>
                    <span class="date">8 Nov. 2015</span>
                </div><!--post header-->
                <div class="post-img">
                    <a href="#">
                ...
                <div class="post-meta">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            <ul class="socials list-inline clearfix">
                                <li><span>Share:</span></li>
                                <li> <a href="#" class="social-icon-sm si-gray si-gray-round si-facebook">
                                        <i class="fa fa-facebook"></i>
                                        <i class="fa fa-facebook"></i>
                                    </a></li>
                                <li><a href="#" class="social-icon-sm si-gray si-gray-round si-twitter">
                                        <i class="fa fa-twitter"></i>
                                        <i class="fa fa-twitter"></i>
                                    </a></li>
                                <li><a href="#" class="social-icon-sm si-gray si-gray-round si-g-plus">
                                        <i class="fa fa-google-plus"></i>
                                        <i class="fa fa-facebook"></i>
                                    </a></li>
                                <li> <a href="#" class="social-icon-sm si-gray si-gray-round si-pinterest">
                                        <i class="fa fa-pinterest"></i>
                                        <i class="fa fa-pinterest"></i>
                                    </a></li>
                                <li><a href="#" class="social-icon-sm si-gray si-gray-round si-instagram">
                                        <i class="fa fa-instagram"></i>
                                        <i class="fa fa-instagram"></i>
                                    </a></li>
                            </ul>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="post grid-post">
                        ...
                        <div class="post-header text-center">
                            <span class="tag"><a href="#"><i class="fa fa-tag"></i> Travel</a></span>
                            <h3 class="post-title"><a href="#">Lorem ipsum cogarts.</a></h3>
                            <span class="date">8 Nov. 2015</span>
                        </div><!--post header-->
                        <div class="post-entry">
                            <p>
        ...
        <div class="col-md-3 col-md-offset-1">
            <aside class="sidebar">
                <div class="widget">
                    <form class="search-widget">
                        <input type="text" class="form-control" placeholder="Tpye ans hit enter">
                        <button type="button"> <i class="fa fa-search"></i></button>
                    </form>
                </div>
                <div class="widget text-center">
                    ...
                    <p>
                        Craft beer elit seitan exercitation, photo booth et 8-bit kale chips proident chillwave deep v laborum. Aliquip veniam delectus
                    </p>
                    <a href="#">Read More</a>
                </div><!--widget-->
                <div class="widget text-center">
                    ...
                    <div class="fb-page" data-href="https://web.facebook.com/rakeshdesigns/" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="false"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://web.facebook.com/rakeshdesigns/"><a href="https://web.facebook.com/rakeshdesigns/">Design_mylife</a></blockquote></div></div>
                </div><!--widget-->
                <div class="widget">
                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="media-object" src="/images/img-12.jpg" width="70" alt="...">
                            </a>
                        </div>
                        <div class="media-body">
                            <h4 class="media-heading"><a href="#">Photo booth anim 8-bit hella</a></h4>
                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="media-object" src="/images/img-11.jpg" width="70" alt="...">
                            </a>
                        </div>
                        <div class="media-body">
                            <h4 class="media-heading"><a href="#">Photo booth anim 8-bit hella</a></h4>
                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="media-object" src="/images/img-10.jpg" width="70" alt="...">
                            </a>
                        </div>
                        <div class="media-body">
                            <h4 class="media-heading"><a href="#">Photo booth anim 8-bit hella</a></h4>
                ...
                <div class="widget">
                    ...
                    <div class="instagram-list clearfix">
                        <a href="#">
...
<script type="text/javascript" src="/frontend/js/revolution/js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript" src="/frontend/js/revolution/js/jquery.themepunch.tools.min.js"></script>
<!--revolution slider extentions-->
<script type="text/javascript" src="/frontend/js/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script type="text/javascript" src="/frontend/js/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript" src="/frontend/js/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script type="text/javascript" src="/frontend/js/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
